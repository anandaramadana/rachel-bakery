...
<script src="{{ asset('assets/template-admin/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
...
<!-- <script src="{{ asset('assets/template-admin/js/demo/chart-pie-demo.js') }}"></script> -->
